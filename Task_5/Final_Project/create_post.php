    ...
    <div class="card shadow p-4">
        ...
        <?php if ($create_success): ?>
            <div class="alert alert-success text-center">
                <i class="bi bi-check-circle-fill"></i> Post created successfully!
                <br>
        ...
        <?php else: ?>
            <form method="post" autocomplete="off">
                ...
                <div class="mb-3">
                    ...
                    <textarea name="content" class="form-control" rows="7" required placeholder="Enter content"></textarea>
                </div>
                <div class="d-flex justify-content-between">
                    <button type="submit" class="btn btn-success"><i class="bi bi-plus-circle"></i> Create Post</button>
